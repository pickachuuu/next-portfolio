    ...
    <footer className='w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto'>
      ...
      <AnimationContainer customClassName='w-full grid place-items-center grid-cols-2 gap-1 lg:gap-4 pb-8 sm:grid-cols-2 mx-3'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <ExternalLink href='https://github.com/pickachuuu'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
          ...
          <ExternalLink href='https://www.linkedin.com/in/chris-derek-berbo-b81a612a4/'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          {/* <ExternalLink href='https://rxresu.me/Derek/cv-derek-berbo'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
